                ...
                ?>
                                ...
                                <?php
                                        ...
                                        $row = mysqli_fetch_assoc($result);
                                            ...
                                            echo "<p><span class='item_price'>{$row['product_special']} JD</span>
                                            <del>{$row['product_price']} JD</del>
                                        </p>";
											...
											<div class="googles single-item singlepage">
													<form action="#" method="post">
                                                        ...
                                                        $rows = mysqli_fetch_assoc($result);
                                                            ...
                                                            echo "<label>Quantity</label><input type='text' name='quantity' placeholder='1'>";
